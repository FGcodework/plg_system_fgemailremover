...
1. Download the release ZIP matching your Joomla version from the [Releases](https://github.com/FGcodework/plg_system_fgemailremover/releases) page — the classic build's asset is named `plg_system_fgemailremover_vX.Y.Z.zip`, the native Joomla 4-6 build's is `plg_system_fgemailremover_j46_vX.Y.Z.zip`.
